...
function Account(props) {
  ...
  return (
    <div className="row mt-5">
      <div className="col d-flex align-items-center border-bottom my-2" onClick={handleClickAddress}>
      ...
      <div className="col d-flex align-items-center border-bottom my-2" onClick={handleClickFavorite}>
      ...
      <div className="col d-flex align-items-center my-2" onClick={handleClickPromo}>
